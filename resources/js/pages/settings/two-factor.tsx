        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        title="Autenticação de dois fatores"
                        description="Gerencie a autenticação de dois fatores"
                    />
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                você precisará informar um código seguro durante
                                o login, gerado pelo app autenticador (TOTP) no
                                seu celular.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                Esse código vem do app autenticador (TOTP) no
                                seu celular.
                            </p>
